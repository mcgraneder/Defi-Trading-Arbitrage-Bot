...
function* addressFromAddressLikeValue(dataType, input, wrapOptions) {
...
function* addressFromUdvtValue(dataType, input, wrapOptions) {
    if (!Utils.isWrappedResult(input)) {
        throw new errors_1.TypeMismatchError(dataType, input, wrapOptions.name, 1, "Input was not a wrapped result");
    }
    ...
    return yield* addressFromAddressLikeValue(dataType, input.value, wrapOptions);
}
