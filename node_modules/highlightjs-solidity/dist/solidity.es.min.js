...
;var l=n.map((e=>"bytes"+e)).join(" ")+" ",o=r.map((e=>"uint"+e)).join(" ")+" ",g=r.map((e=>"int"+e)).join(" ")+" ",M=[].concat.apply([],r.map((e=>t.map((a=>e+"x"+a))))),p={
...
},x("msg","gas value data sender sig"),x("block","blockhash coinbase difficulty gaslimit basefee number timestamp chainid"),x("tx","gasprice origin"),x("abi","decode encode encodePacked encodeWithSelector encodeWithSignature"),x("bytes","concat"),f,{
