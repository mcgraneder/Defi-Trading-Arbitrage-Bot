...
//             var uniswapAmountDaiForInputETH = await uniswapRouterContract.methods.getAmountIn(amountIn, uniswapReserve0, uniswapReserve1).call() //in wei
//             var sushiswapAmountDaiForInputETH = await sushiswapRouterContract.methods.getAmountIn(amountIn, uniswapReserve0, uniswapReserve1).call() //in wei
//             // var sakeswapAmountDaiForInputETH = await uniswapRouterContract.methods.getAmountIn(amountIn, sakeswapReserve0, sakeswapReserve1).call() //in wei
//             var crowswapAmountDaiForInputETH = await uniswapRouterContract.methods.getAmountIn(amountIn, crowswapReserve0, crowswapReserve1).call() //in wei
//             var shibaswapAmountDaiForInputETH = await sushiswapRouterContract.methods.getAmountIn(amountIn, shibaswapReserve0, shibaswapReserve1).call() //in wei

//             var uniswapAmountETHForInputDAI = await sushiswapRouterContract.methods.getAmountOut(amountIn, uniswapReserve1, uniswapReserve0).call(); //in wei
//             var sushiswapAmountETHForInputDAI = await sushiswapRouterContract.methods.getAmountOut(amountIn, sushiswapReserve1, sushiswapReserve0).call(); //in wei
//             var sakeswapAmountETHForInputDAI = await uniswapRouterContract.methods.getAmountOut(amountIn, sakeswapReserve1, sakeswapReserve0).call(); //in wei
//             var crowswapAmountETHForInputDAI = await uniswapRouterContract.methods.getAmountOut(amountIn, crowswapReserve1, crowswapReserve0).call(); //in wei
//             var shibaswapAmountETHForInputDAI = await sushiswapRouterContract.methods.getAmountOut(amountIn, shibaswapReserve1, shibaswapReserve0).call(); //in wei
            


//             console.log(
//                 `${amountToTradeInEth} WETH will buy you ${web3.utils.fromWei(uniswapAmountDaiForInputETH.toString(), "Ether")} DAI on Uniswap. ` +
...
//             //now we can claulate the difference between the rates on the different exachanges in order to figure out what exchange to
//             //take out the flashswap on. The price is the difference between the in and out results
//             var uniSushiPriceDifference = (sushiswapAmountETHForInputDAI / amountIn) - (uniswapAmountDaiForInputETH/amountIn);
//             var sushiUniPriceDifference = (uniswapAmountETHForInputDAI / amountIn) - (sushiswapAmountDaiForInputETH/amountIn);

//             var uniCrowPriceDifference = (crowswapAmountETHForInputDAI / amountIn) - (uniswapAmountDaiForInputETH/amountIn);
//             var CrowUniPriceDifference = (uniswapAmountETHForInputDAI / amountIn) - (crowswapAmountDaiForInputETH/amountIn);

//             var uniShibaPriceDifference = (shibaswapAmountETHForInputDAI / amountIn) - (uniswapAmountDaiForInputETH/amountIn);
//             var ShibaUniPriceDifference = (uniswapAmountETHForInputDAI / amountIn) - (shibaswapAmountDaiForInputETH/amountIn);

//             var crowUniPriceDifference = (uniswapAmountETHForInputDAI / amountIn) - (crowswapAmountDaiForInputETH/amountIn);
//             var uniCrowPriceDifference = (crowswapAmountETHForInputDAI / amountIn) - (uniswapAmountDaiForInputETH/amountIn);

//             var crowShibaPriceDifference = (shibaswapAmountETHForInputDAI / amountIn) - (crowswapAmountDaiForInputETH/amountIn);
//             var shibaCrowPriceDifference = (crowswapAmountETHForInputDAI / amountIn) - (shibaswapAmountDaiForInputETH/amountIn);

//             var crowSushiPriceDifference = (sushiswapAmountETHForInputDAI / amountIn) - (crowswapAmountDaiForInputETH/amountIn);
//             var sushiCrowPriceDifference = (crowswapAmountETHForInputDAI / amountIn) - (sushiswapAmountDaiForInputETH/amountIn);

//             var sushiShibaPriceDifference = (shibaswapAmountETHForInputDAI / amountIn) - (sushiswapAmountDaiForInputETH/amountIn);
//             var shibaSushiPriceDifference = (sushiswapAmountETHForInputDAI / amountIn) - (shibaswapAmountDaiForInputETH/amountIn);
...
//             var crowSakePriceDifference = (sakeswapAmountETHForInputDAI / amountIn) - (crowswapAmountDaiForInputETH/amountIn);
            

//            console.log(uniSushiPriceDifference, sushiUniPriceDifference)
//            console.log(uniCrowPriceDifference, CrowUniPriceDifference)
//            console.log(uniShibaPriceDifference, ShibaUniPriceDifference)
//            console.log(crowUniPriceDifference, uniCrowPriceDifference)
//            console.log(crowShibaPriceDifference, shibaCrowPriceDifference)
//            console.log(crowSushiPriceDifference, sushiCrowPriceDifference)
//            console.log(crowSakePriceDifference, sushiUniPriceDifference)
//            console.log(sushiShibaPriceDifference, shibaSushiPriceDifference)
