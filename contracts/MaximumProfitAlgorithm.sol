...
contract MaximumProfit {
    ...
    // address WETH;
    address[] baseTokens = [0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2, 0xF7d78aD1c7aA9026be9cf6595922d4921B4FcA2d];
    ...
    function getProfit(address pool0, address pool1, uint amount) public returns (uint256 profit, address baseToken) {
        ...
        uint256 debtAmount = getAmountIn(amount, orderedReserves.a1, orderedReserves.b1);
        // sell borrowed quote token on higher price pool
        uint256 baseTokenOutAmount = getAmountOut(amount, orderedReserves.b2, orderedReserves.a2);
    ...
    function sqrt(uint256 n) public pure returns (uint256 res) {
        assert(n > 1);
